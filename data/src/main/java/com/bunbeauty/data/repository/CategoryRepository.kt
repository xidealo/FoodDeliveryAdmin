...
class CategoryRepository(
    ...
    override suspend fun saveCategoryPriority(
        token: String,
        category: List<Category>,
    ) {
        val patchCategoryList =
            PatchCategoryList(
                patchCategoryItemList =
