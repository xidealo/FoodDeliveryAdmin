...
class GetTypeWorkUseCaseTest {
    ...
    @Test
    fun `invoke() should return CafeData when cafeUuid exists`() =
        runTest {
            // Given
    ...
    fun `invoke() should throw NotFoundWorkInfoException when getTypeWork returns null`() =
        runTest {
            ...
            // When & Then
            val exception =
                assertThrows(NotFoundWorkInfoException::class.java) {
