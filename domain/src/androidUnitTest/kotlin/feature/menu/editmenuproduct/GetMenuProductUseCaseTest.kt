package test.feature.menu.editmenuproduct
...
class GetMenuProductUseCaseTest {
    ...
    @Test
    fun `throw NotFoundMenuProductException when menu product is null`() =
        runTest {
            // Given
    ...
    @Test
    fun `return menu product when menu product is not null`() =
        runTest {
            // Given
            val menuProductUuid = "menuProductUuid"
            val companyUuid = "companyUuid"
