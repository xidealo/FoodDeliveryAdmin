package test.feature.menu.additiongroupformenuproduct.editadditiongroupformenuproduct
...
class GetAdditionGroupWithAdditionsForMenuUseCaseTest {
    ...
    private lateinit var getFilteredAdditionGroupWithAdditionsForMenuProductUseCase:
    ...
    @Test
    fun `return addition group with additions when input is valid`() =
        runTest {
            // Given
    ...
    @Test
    fun `throw NoCompanyUuidException when companyUuid is null`() =
        runTest {
            // Given
            val menuProductUuid = "menu-uuid-1"
            val additionGroupUuid = "addition-group-1"
    ...
    @Test
    fun `throw NoAdditionGroupException when addition group is not found`() =
        runTest {
            // Given
    ...
    @Test
    fun `throw NoAdditionGroupException when menu product is null`() =
        runTest {
            // Given
            val menuProductUuid = "menu-uuid-1"
            val additionGroupUuid = "addition-group-1"
    ...
    private val additionGroupWithAdditionsMock =
