package test.feature.additionlist
...
import com.bunbeauty.domain.feature.additionlist.SeparatedAdditionList
...
class GetSeparatedAdditionListUseCaseTest {
    ...
    @Test
    fun `return empty lists when additionRepo return empty list`() =
        runTest {
            // Given
            val token = "token"
            val expectedSeparatedAdditionList =
                SeparatedAdditionList(
    ...
    private val groupedAdditionList =
        GroupedAdditionList(
            uuid = "",
            title = null,
            additionList = listOf(),
