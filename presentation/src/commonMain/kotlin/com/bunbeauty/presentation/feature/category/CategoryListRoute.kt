    ...
    LazyColumn(
        ...
        items(
            ...
            Column {
                ...
                com.bunbeauty.presentation.designsystem.compose.element.topbar.AdminHorizontalDivider(
...
private fun CategoriesListSuccessDragScreen(
    ...
    com.bunbeauty.presentation.designsystem.compose.element.DragDropList(
        items = state.categoryList,
        itemKey = { it.uuid },
