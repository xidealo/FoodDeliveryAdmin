...
class MenuFragment : BaseComposeFragment<Menu.DataState, MenuViewState, Menu.Action, Menu.Event>() {
    ...
    @Composable
    override fun mapState(state: Menu.DataState): MenuViewState = MenuViewState
